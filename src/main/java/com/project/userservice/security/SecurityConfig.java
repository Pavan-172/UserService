...
public class SecurityConfig {
	...
	public SecurityConfig(BCryptPasswordEncoder byBCryptPasswordEncoder){
...
//	commented becuase we have implemnted custom User Details service so in order to remove multiple beans
//	@Bean
